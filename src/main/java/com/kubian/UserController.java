...
public class UserController {
		...
		try {
			...
			if (userName.equals("") || userName == null || userPwd.equals("") || userPwd == null) {
				...
				if ("admin".equals(user.getUserName())) {
					flag = userDao.findByUserNameAndUserPwdAndUserRole(user.getUserName(), user.getUserPwd(), 5);
	 ...
	 * @date 2018年6月29日
	 */
	@RequestMapping(value = "/getPageImg")
	public Object getPageImg() {
		User user = userDao.getUserByUserNameAndUserRole("admin", 5);
		return user;
	}
