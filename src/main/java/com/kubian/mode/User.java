...
public class User implements Serializable {
	...
	public User(){}
	public User(String homePageImg, String detailPageImg) {
		this.homePageImg = homePageImg;
		this.detailPageImg = detailPageImg;
	}
	...
	public String getDetailPageImg() {
		return detailPageImg;
	}

	public void setDetailPageImg(String detailPageImg) {
		this.detailPageImg = detailPageImg;
	}
